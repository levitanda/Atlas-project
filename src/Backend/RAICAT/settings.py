"""
Django settings for RAICAT project.
...
SECRET_KEY = 'django-insecure-2obir+rfw%u7!e%)xm+o$q=4mxjvgq@!t6@ys90a&i5y_xy!z-'
...
WSGI_APPLICATION = 'RAICAT.wsgi.application'
